...
public interface IRepositorio {
	 ...
	 * @return
	 *		retorna uma arraylist com as pessoas cadastradas
	 * @throws RepositorioException
	 * 		lançado quando há problemas na conexão com o repositório
	 */
	 ...
	 * 		id da pessoa
	 * @return
	 * 		retorna o resultado da busca pelo id em forma de ArrayList
	 * @throws RepositorioException
	 * 		lançado quando há problemas na conexão com o repositório
	 */
	 ...
	 * 		nome da pessoa
	 * @return
	 * 		retorna o resultado da busca pelo nome em forma de ArrayList
	 * @throws RepositorioException
	 * 		lançado quando há problemas na conexão com o repositório
	 */
	 ...
	 * 		cpf da pessoa
	 * @return
	 * 		retorna o resultado da busca pelo cpf em forma de ArrayList
	 * @throws RepositorioException
	 * 		lançado quando há problemas na conexão com o repositório
	 */
	 ...
	 * @return
	 * 		retorna uma ArrayList com todas as matérias
	 * @throws RepositorioException
	 * 		lançado quando há problemas na conexão com o repositório
	 */
	 ...
	 * @return
	 * 		retorna o resultado da busca em forma de ArrayList
	 * @throws RepositorioException
	 * 		lançado quando há problemas na conexão com o repositório
	 */
	 ...
	 * @return
	 * 		retorna o resultado da busca nas matérias em forma de ArrayList
	 * @throws RepositorioException
	 * 		lançado quando há problemas na conexão com o repositório
	 */
	 ...
	 * @return
	 * 		retorna as atividades em um ArrayList
	 * @throws RepositorioException
	 * 		lançado quando há problemas na conexão com o repositório
	 */
