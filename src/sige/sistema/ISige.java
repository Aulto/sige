...
public interface ISige {
	 ...
	 * @return
	 * 		retorna true caso haja ao menos um administrador registrado, retorna false caso contrário
	 * @throws ProblemaInterno
	 * 		lançado quando há um problema no sistema
	 */
	 ...
	 * 		lançado quando o usuário que executa a ação não tem privilégios para executá-la
	 * @throws ProblemaInterno
	 * 		lançado quando há um problema no sistema
	 */
	 ...
	 * @return
	 * 		retorna arraylist de Pessoa com os resultados
	 * @throws AutenticacaoException
	 * 		lançado quando o usuário que executa a ação não tem privilégios para executá-la
	 * @throws ProblemaInterno
	 ...
	 * 		nome a ser buscado
	 * @return
	 * 		retorna arraylist de pessoa com os resultados da busca
	 * @throws AutenticacaoException
	 * 		lançado quando o usuário que executa a ação não tem privilégios para executá-la
	 * @throws ProblemaInterno
	 * 		lançado quando há um problema no sistema
	 ...
	 * 		lançado quando há um problema no sistema
	 */
	ArrayList<Pessoa> buscarAlunoNome(String nome) throws AutenticacaoException,
			ProblemaInterno;
	 ...
	 * 		lançado quando há um problema no sistema
	 */
	ArrayList<Pessoa> buscarAlunoCpf(String cpf)
			throws AutenticacaoException, ProblemaInterno;
	 ...
	 * @return
	 * 		retorna o Repositório instanciado na classe
	 */
