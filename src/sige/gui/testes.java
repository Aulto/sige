...
public class testes extends JFrame {
	...
	public testes() {
		...
		JLabel jlSistemaDeAlocao = new JLabel(
		...
		gl_jpDisciplinas.setHorizontalGroup(gl_jpDisciplinas
				.createParallelGroup(Alignment.LEADING).addGap(0, 429,
						Short.MAX_VALUE));
		gl_jpDisciplinas.setVerticalGroup(gl_jpDisciplinas.createParallelGroup(
				Alignment.LEADING).addGap(0, 234, Short.MAX_VALUE));
